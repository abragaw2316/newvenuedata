...
- **Cost: $0 recurring** (OSM + public sites + local Ollama + SQLite + manual send from the free Zoho mailbox). Paid options (Google Places, paid enrichment, cloud LLM, ESP+warmed domain) are all deferred with free alternatives chosen.
